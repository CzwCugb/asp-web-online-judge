    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="nav-buttons">
                ...
                <!-- 新增测试用例管理入口 -->
                <asp:LinkButton ID="lnkTestCases" runat="server" OnClick="lnkTestCases_Click" CssClass="nav-link">测试用例管理</asp:LinkButton>
            </div>
            ...
            <div class="main-content">
                <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                    ...
                    <asp:View ID="viewUserOverview" runat="server">
                        ...
                        <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" OnRowCommand="gv_RowCommand" CssClass="gridview">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditUser" runat="server" CommandName="EditUser" CommandArgument='<%# Eval("id") %>'>编辑</asp:LinkButton>
                                        &nbsp;
                                        <asp:LinkButton ID="lnkDeleteUser" runat="server" CommandName="DeleteUser" CommandArgument='<%# Eval("id") %>' OnClientClick="return confirm('确定删除该用户吗？');">删除</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                        ...
                        <div class="GridViewPager">
                            <asp:Repeater ID="rptUserPagination" runat="server">
                                <ItemTemplate>
                                    <a href='<%# Eval("Value") %>' style='<%# ((System.Web.UI.WebControls.ListItem)Container.DataItem).Selected ? "font-weight:bold;" : "" %>'>
                                        <%# Eval("Text") %>
                                    </a>
                                </ItemTemplate>
                            </asp:Repeater>
                    ...
                    <asp:View ID="viewProblemOverview" runat="server">
                        ...
                        <asp:GridView ID="gvProblems" runat="server" AutoGenerateColumns="False" OnRowCommand="gv_RowCommand" CssClass="gridview">
                            <Columns>
                                <asp:BoundField DataField="id" HeaderText="ID" />
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditProblem" runat="server" CommandName="EditProblem" CommandArgument='<%# Eval("id") %>'>编辑</asp:LinkButton>
                                        &nbsp;
                                        <asp:LinkButton ID="lnkDeleteProblem" runat="server" CommandName="DeleteProblem" CommandArgument='<%# Eval("id") %>' OnClientClick="return confirm('确定删除该题目吗？');">删除</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <asp:View ID="viewCategoryOverview" runat="server">
                        ...
                        <asp:GridView ID="gvCategories" runat="server" AutoGenerateColumns="False" OnRowCommand="gv_RowCommand" CssClass="gridview">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditCategory" runat="server" CommandName="EditCategory" CommandArgument='<%# Eval("category_id") %>'>编辑</asp:LinkButton>
                                        &nbsp;
                                        <asp:LinkButton ID="lnkDeleteCategory" runat="server" CommandName="DeleteCategory" CommandArgument='<%# Eval("category_id") %>' OnClientClick="return confirm('确定删除该题单吗？');">删除</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <asp:View ID="viewCompetitionOverview" runat="server">
                        ...
                        <asp:GridView ID="gvCompetitions" runat="server" AutoGenerateColumns="False" OnRowCommand="gv_RowCommand" CssClass="gridview">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditCompetition" runat="server" CommandName="EditCompetition" CommandArgument='<%# Eval("competition_id") %>'>编辑</asp:LinkButton>
                                        &nbsp;
                                        <asp:LinkButton ID="lnkDeleteCompetition" runat="server" CommandName="DeleteCompetition" CommandArgument='<%# Eval("competition_id") %>' OnClientClick="return confirm('确定删除该比赛吗？');">删除</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <!-- 测试用例总览视图 -->
                    <asp:View ID="viewTestCaseOverview" runat="server">
                        <h2>测试用例管理</h2>
                        <div class="search-panel">
                            <asp:TextBox ID="txtTestCaseSearch" runat="server" CssClass="search-box"></asp:TextBox>
                            <asp:Button ID="btnTestCaseSearch" runat="server" Text="搜索" OnClick="btnTestCaseSearch_Click" CssClass="btn" />
                            <asp:Button ID="btnAddTestCase" runat="server" Text="添加新测试用例" OnClick="btnAddTestCase_Click" CssClass="btn" />
                        </div>
                        <asp:GridView ID="gvTestCases" runat="server" AutoGenerateColumns="False" OnRowCommand="gv_RowCommand" CssClass="gridview">
                            <Columns>
                                <asp:BoundField DataField="test_case_id" HeaderText="ID" />
                                <asp:BoundField DataField="problem_id" HeaderText="题目ID" />
                                <asp:BoundField DataField="input_data" HeaderText="输入数据" />
                                <asp:BoundField DataField="output_data" HeaderText="期望输出" />
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkEditTestCase" runat="server" CommandName="EditTestCase" CommandArgument='<%# Eval("test_case_id") %>'>编辑</asp:LinkButton>
                                        &nbsp;
                                        <asp:LinkButton ID="lnkDeleteTestCase" runat="server" CommandName="DeleteTestCase" CommandArgument='<%# Eval("test_case_id") %>' OnClientClick="return confirm('确定删除该测试用例吗？');">删除</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                        <div class="GridViewPager">
                            <asp:Repeater ID="rptTestCasePagination" runat="server">
                                <ItemTemplate>
                                    <a href='<%# Eval("Value") %>' style='<%# ((System.Web.UI.WebControls.ListItem)Container.DataItem).Selected ? "font-weight:bold;" : "" %>'>
                                        <%# Eval("Text") %>
                                    </a>
                    ...
                    <!-- 测试用例编辑视图 -->
                    <asp:View ID="viewTestCaseDetail" runat="server">
                        <h2>编辑测试用例</h2>
                        <p>
                            <label>测试用例ID:</label>
                            <asp:Label ID="lblTestCaseIdValue" runat="server" Text="0"></asp:Label>
                        </p>
                        <p>
                            <label>题目ID:</label>
                            <asp:TextBox ID="txtTestCaseProblemId" runat="server"></asp:TextBox>
                        </p>
                        <p>
                            <label>输入数据:</label>
                            <asp:TextBox ID="txtTestCaseInputData" runat="server" TextMode="MultiLine" Rows="4"></asp:TextBox>
                        </p>
                        <p>
                            <label>期望输出:</label>
                            <asp:TextBox ID="txtTestCaseOutputData" runat="server" TextMode="MultiLine" Rows="4"></asp:TextBox>
                        </p>
                        <p>
                            <label>题内测试用例编号:</label>
                            <asp:TextBox ID="txtInProblemCaseId" runat="server"></asp:TextBox>
                        </p>
                        <asp:Button ID="btnSaveTestCase" runat="server" Text="保存" OnClick="btnSaveTestCase_Click" CssClass="btn" />
                        <asp:Button ID="btnCancelTestCase" runat="server" Text="取消" OnClick="btnCancel_Click" CssClass="btn" />
                    </asp:View>
